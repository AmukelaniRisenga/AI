...
export const handler = async (event) => {
  ...
  try {
    ...
    if (!text && !imageBase64) {
      return { statusCode: 400, body: JSON.stringify({ error: 'Provide either text or imageBase64' }) }
    }
...
If unsure, use "default-box".`
    ...
    if (!VALID_MODEL_KEYS.includes(parsed.modelKey)) parsed.modelKey = 'default-box'
